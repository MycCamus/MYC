...
model = YOLO("path/to/CBAMbest.pt")  # Load a custom trained model
...
yolo track model=path/to/CBAMbest.pt source="https://youtu.be/LNwODJXcvt4"  # Custom trained model

# Track using ByteTrack tracker
yolo track model=path/to/CBAMbest.pt tracker="bytetrack.yaml"
```
